...
\begin{frame}{Arquillian persistence test}
\lstset{basicstyle={\tiny},upquote=true,language=Java}
  \lstinputlisting[firstline=69,lastline=94,title={Persistance test}]{../code/arquillian-persistence-tutorial/src/test/java/org/arquillian/example/GamePersistenceTest.java}
\end{frame}
...
\begin{frame}{Arquillian functional test}
\lstset{basicstyle={\tiny},upquote=true,language=Java}
  \lstinputlisting[firstline=58,lastline=75,title={Functional test}]{../code/arquillian-drone-tutorial/src/test/java/org/arquillian/example/ui/LoginScreenSeleniumTest.java}
 \begin{itemize}
