...
\lstset{language=Java,
  ...
  breaklines=true, tabsize=2, keywordstyle=\color{blue},backgroundcolor=\color{lightgray},commentstyle=\color{gray},numberstyle=\tiny,stepnumber=5, firstnumber=1, numbersep=5pt}
\lstset{                       
